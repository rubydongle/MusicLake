...
import com.midas.music.ui.music.dialog.CreatePlaylistDialog
import com.midas.music.ui.music.edit.PlaylistManagerUtils
import com.midas.music.ui.music.playlist.PlaylistAdapter
import com.midas.music.ui.music.playlist.edit.PlaylistManagerActivity
 ...
 * 我的 界面
 */
class LocalPlaylistFragment : BaseFragment<LocalPresenter>(), LocalPlaylistContract.View {
    ...
    override fun getLayoutId(): Int {
        return R.layout.frag_local_playlist
    }
    ...
    override fun listener() {
        ...
        playlistAddIv.setOnClickListener {
            ...
            if (playlistTag == Constants.PLAYLIST_CUSTOM_ID && !UserStatus.getLoginStatus()) {
                ToastUtils.show(getString(com.midas.music.R.string.prompt_login))
            } else {
...
//        mPresenter?.updateDownload()
    ...
    companion object {
        ...
        fun newInstance(): LocalPlaylistFragment {
            val args = Bundle()
            val fragment = LocalPlaylistFragment()
