package com.midas.music.ui.music.playlist.square
...
import com.midas.music.ui.music.playlist.PlaylistActivity
import com.midas.music.ui.widget.channel.Channel
import com.midas.music.ui.widget.channel.ChannelView
...
class AllPlaylistCatFragment : androidx.fragment.app.DialogFragment(), ChannelView.OnChannelListener {
    ...
    private val backIv by lazy { rootView?.findViewById<ImageView>(com.midas.music.R.id.backIv) }
    ...
    override fun onStart() {
        dialog?.let {
            ...
            lp?.windowAnimations = com.midas.music.R.style.dialogAnim
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        if (rootView == null) {
            rootView = inflater.inflate(com.midas.music.R.layout.frag_playlist_category, container, false)
        }
