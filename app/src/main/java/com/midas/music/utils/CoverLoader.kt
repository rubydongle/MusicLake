...
import com.midas.music.api.GlideApp
...
object CoverLoader {
    ...
    fun getCoverUri(context: Context, albumId: String): String? {
        ...
        return ContentUris.withAppendedId(Uri.parse("content://media/external/audio/albumart"), albumId.toLong()).toString()
//        var uri: String? = null
//        try {
